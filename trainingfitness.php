...
<body>
    ...
    <!-- Training and Fitness Products -->
    <div class="product-page">
        <h2>Training and Fitness Products</h2>
        <div class="product-grid">
            <?php
            $sql = "SELECT product_id, prod_name, prod_description, prod_price, product_image FROM product WHERE category_id = '444'";
